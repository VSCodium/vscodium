...
# Vendored verbatim from electron/electron: script/lib/patches.py (commit e12e04e87b).
# Copyright (c) Electron contributors
# Copyright (c) 2013-2020 GitHub Inc.
# Licensed under the MIT License. See dev/lib/NOTICE for the full license text.
