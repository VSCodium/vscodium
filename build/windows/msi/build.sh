...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="Shell-IDE - Insiders"
  PRODUCT_CODE="ShellIDEInsiders"
  ...
  PRODUCT_NAME="Shell-IDE"
  PRODUCT_CODE="ShellIDE"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="Shell-IDE-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="Shell-IDE-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
